...
const { dumpAttachment, readForIndex, collectDirFiles, attachmentContext, looksLikeInjection, untrustedNote } = require('./attachments');
const { pickEmbedModel, retrieve, warmIndex } = require('./retrieval');
...
module.exports = { assembleKnowledge, warmAttachment };
