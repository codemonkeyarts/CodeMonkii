...
|---|--:|--:|--:|--:|:--|
| 128 KB (~33k tok) | 154 | 21.2 s | 107 ms | **−88%** | ✓ found |
| 512 KB (~131k tok) | 768 | 8.1 s | 149 ms | **−88%** | ✓ found |
| 2 MB (~524k tok) | 3,219 | 33.7 s | 359 ms | **−88%** | ✓ found |
...
|---|--:|--:|
| Retrieved passages | 3,642 | **1.7 s** |
| Full dump (120 KB cap) | 26,712 | 18.2 s |

Retrieval reaches the first token **~10.4× sooner**. And a full manuscript (500k+ tokens) is far over a 32k window and can't be sent at all — retrieval is what makes it fit.
